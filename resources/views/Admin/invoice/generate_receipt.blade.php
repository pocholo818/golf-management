    ...
    <div class="container mb-5 mt-3">
      <div class="row d-flex align-items-baseline">
        <div class="col-xl-9">
          ...
          <p style="color: #7e8d9f;font-size: 20px;">Invoice >> <strong>No: {{ $member->invoice_number }} </strong></p>
        ...
        <div class="row">
          <div class="col-xl-8">
            <ul class="list-unstyled">
              ...
              <li class="text-muted">
                  <span style="display: inline-block; width: 120px;">Member ID:</span>{{ $member->customer_id }}
              </li>
              <li class="text-muted">
...
<table class="table table-striped table-borderless" style="text-align: center">
  ...
  <tbody>
      ...
      @php
        $types = explode(', ', $member->type);
        $amounts = explode(', ', $member->amount);
      @endphp
      ...
      @endforeach
        ...
        <div class="row d-flex justify-content-end">
          ...
          <div class="col-md-3 ">
              ...
              <p class="text-black float-center"><span class="text-black me-2">₱</span><span class="text-black me-3"> <strong> {{ $member->total }} </strong> </span><span
                  style="font-size: 25px;"></span></p>
            </div>
        </div>
        ...
        <div class="row">
          <div >
            ...
            <div class="d-flex justify-content-end">
              ...
              <a href="{{ route('admin_invoice') }}" class="mr-2">
                  <button type="submit" class="btn btn-primary text-capitalize" style="background-color:#15a302; ">Done</button>
                </a>
            </div>
          </div>
