...
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="row">
            ...
            <div class="col-2">
                <a href="{{ route('search_kiosk_member') }}">
                    ...
                    <tbody>
                        ...
                        @foreach ($kiosk as $item)
                            <tr>
                                ...
                                <td>{{ $item->remarks }}</td>
                                <td>
                                    <a href="{{ route('edit_kiosk', $item->bill_id) }}">
                                        <button type="button" class="btn btn-primary">
                                            Edit
                                        </button>
                                    </a>
                                    <a href="{{ route('delete_kiosk', $item->bill_id) }}"
                                    ...
                                    <form id="delete-form-{{ $item->bill_id }}"
                                        action="{{ route('delete_kiosk', $item->bill_id) }}" method="post"
                                        style="display: none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
