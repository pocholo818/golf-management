...
@section('content')
    ...
    <div class="modal-body">
        ...
        <form action="{{ route('update_merchandise',  $prod->bill_id) }}" method="post" enctype="multipart/form-data"
            class="row g-3">
            {!! csrf_field() !!}
            @method('PUT')
            ...
            <div class="">
                ...
                <input type="text" name="member_name" class="form-control" id="exampleFormControlInput1"
                    value="{{ $prod->member_name }}" readonly>
            </div>
            <div class="">
                ...
                <input type="text" name="account_id" class="form-control" id="exampleFormControlInput1"
                    value="{{ $prod->account_id }}" readonly>
            </div>
            <div class="">
